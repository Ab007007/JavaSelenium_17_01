...
public class FormFillUsingReusableFunctions 
{
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		Thread.sleep(5000);
		WebdriverUtils.entrText("id", "first-name", "Aravinda");
		Thread.sleep(2000);
		WebdriverUtils.entrText("id", "last-name", "HB");
		Thread.sleep(2000);
		WebdriverUtils.entrText("id", "job-title", "Trainer");
		Thread.sleep(2000);
